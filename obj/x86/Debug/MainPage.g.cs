#pragma checksum "C:\Users\LT88 - BVCN 2\source\repos\demo_control\lLab11_U49\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "B73F4823FE1B452BF5E9FF3513D1BB7A"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace lLab11_U49
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj5_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lLab11_U49.Model.MenuItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::lLab11_U49.Model.MenuItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lLab11_U49.Model.MenuItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::lLab11_U49.Model.MenuItem obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_IcoinFile(obj.IcoinFile, phase);
                        this.Update_Category(obj.Category, phase);
                    }
                }
            }
            private void Update_IcoinFile(global::System.String obj, int phase)
            {
            ...
            private void Update_Category(global::lLab11_U49.Model.SoundCategory obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj12_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lLab11_U49.Model.Sound dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                if (lineNumber == 91 && columnNumber == 82)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::lLab11_U49.Model.Sound) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lLab11_U49.Model.Sound)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::lLab11_U49.Model.Sound obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::lLab11_U49.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::lLab11_U49.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::lLab11_U49.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_MenuIems(obj.MenuIems, phase);
                        this.Update_Sounds(obj.Sounds, phase);
                    }
                }
            }
            private void Update_MenuIems(global::System.Collections.Generic.List<global::lLab11_U49.Model.MenuItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Sounds(global::System.Collections.ObjectModel.ObservableCollection<global::lLab11_U49.Model.Sound> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 9: // MainPage.xaml line 79
                {
                    this.CategotyTextBlock = (global::Windows.UI.Xaml.Controls.TextBlock)(target);
                }
                break;
            case 10: // MainPage.xaml line 80
                {
